![EDIDesK_Platform](IMG/logo.png)

# Platform for the EDIDesK - Erasmus+ HEI project

## Installation

1. *git clone https://github.com/openp2pdesign/EDIDesK_Platform.git* (See also all the options for cloning in GitHub) / or Download this repository and unzip the file 
